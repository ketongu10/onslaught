...
public final class BlockUtils {
    ...
    public static boolean canPlaceBlock(@Nullable Entity placer, World world, BlockPos pos){
        ...
        if(world.isRemote){
            Onslaught.LOGGER.warn("BlockUtils#canPlaceBlock called from the client side! Blocks should be modified server-side only");
            return true;
        }
    ...
    public static int checkBlockBreakXP(@Nullable Entity breaker, World world, BlockPos pos){
        ...
        if(world.isRemote){
            Onslaught.LOGGER.warn("BlockUtils#checkBlockBreakXP called from the client side! Blocks should be modified server-side only");
            return 0;
        }
